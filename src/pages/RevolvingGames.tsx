...
const RevolvingGames:React.FC = () => {
  return (
    <div className=''>
      <div className='text-[20px] text-[#A1A1AA] leading-8 px-[104px]'>
        Casestudies {'>'} Revolving Games
      </div>
      <div className='flex items-center gap-[122px] px-[104px]'>
        <div className='flex flex-col gap-[48px]'>
          ...
          <p className='text-[20px] text-[#959595] leading-8'>Clyde built a secure, responsive checkout embedded in the game server, allowing players to pay instantly with Stripe or USDT without ever leaving gameplay.</p>
          <div className='flex'>
            <img src="/assets/avatargroup.png" alt="" className='h-[46px]'/>
      ...
      {/* Overview */}
      <div className='px-[104px] pt-[160px]'>
        ...
        <p className='text-[20px] text-[#959595] leading-8'>A next-gen game needed a frictionless, in-game purchase experience that worked seamlessly across fiat (Stripe) and crypto (USDT) — without pulling players out of the gameplay. Clyde was brought in to design and build a secure, responsive web purchase flow integrated with their game server.</p>
      </div>
      ...
      <div className='pt-[150px]'>
        ...
        <p className='px-[104px] pb-[70px] text-[#A1A1AA] '>Building a revolving game requires smart design, real-time tech, and seamless monetization. Here are the four key steps:</p>
        ...
        <div className='flex justify-between px-[147px] gap-[167px]'>
          <div>
            ...
            <p className='text-center pt-10'>Core Gameplay <br /> Development</p>
          </div>
          <div>
            <img src="/assets/1.png" alt="" className=''/>
            <p className='text-center pt-10'>Backend & Live <br />Server Integration</p>
          </div>
          <div>
            <img src="/assets/1.png" alt="" className=''/>
            <p className='text-center pt-10'>Monetization & <br />Purchase Flow</p>
          </div>
          <div>
            <img src="/assets/1.png" alt="" className=''/>
            <p className='text-center pt-10'>Live Operations & <br />Content Updates</p>
          </div>
        </div>
      ...
      {/* Challenges */}
      <div className='px-[104px] pt-[130px]'>
      ...
      {/* What we deliver */}
      <div className='px-[104px] pt-[150px]'>
        ...
        <div className='flex gap-[80px]'>
          ...
          <div className='flex flex-col w-[32.4%] gap-[25px]'>
            <div style={{background: 'linear-gradient(180deg, rgba(0, 142, 153, 0.26) 0%, rgba(255, 255, 255, 0.00) 100%)'}} className='flex flex-col items-center gap-[8px] h-1/2 justify-center  rounded-2xl'>
              <h1 className='text-[105px] font-semibold text-center'>70%</h1>
              <p  className='text-[#B5B2B2] text-[16px] '>Increase in player retention</p>
            </div>
            <div style={{background: 'linear-gradient(180deg, rgba(0, 142, 153, 0.26) 0%, rgba(255, 255, 255, 0.00) 100%)'}} className='flex flex-col items-center gap-[8px] h-1/2 justify-center  rounded-2xl'>
              <h1 className='text-[105px] font-semibold text-center'>3x</h1>
      ...
      <div className='px-[104px] pt-[84px]'>
        <div className='flex pl-[60px] pr-[79px] py-[53px] gap-[70px] bg-[#111215] rounded-[28pxd]'>
      ...
      <div className='px-[104px] pt-[80px] pb-[68px]'>
        <div className='bg-[url("/assets/bg5.png")] bg-cover bg-left-bottom flex flex-col items-center '>
