      ...
      <div className="hidden sm:block">
        <div>
          <div className="flex gap-5">
            <div className="w-[61%]">
              <article className="flex flex-col px-7 py-7 mx-auto w-full rounded-[16px] sm:rounded-3xl bg-stone-900">
                <img
                  src="/assets/ipimg1.png"
                  alt="The Evolution of Gaming: From Pixel to Photorealism"
                  className="sm:object-contain w-full rounded-[16px] sm:rounded-3xl sm:aspect-[1.49]"
                />
            ...
            <div className="ml-5 w-[39%]">
              <article className="flex flex-col items-start px-7 py-7 mx-auto w-full rounded-[16px] sm:rounded-3xl bg-stone-900">
                <img
                  src="assets/ipimg2.png"
                  alt="Game Trends in 2025"
                  className="object-contain self-stretch w-full rounded-[16px] sm:rounded-3xl aspect-[0.91]"
                />
                <h2 className="mt-6 text-2xl font-medium tracking-tight text-zinc-100">
                  Game Trends in 2025
                </h2>
        ...
        <div className="mt-12">
          <div className="flex gap-5">
            ...
            <div className="ml-5 w-[61%]">
              <article className="flex flex-col items-start px-7 py-7 mx-auto w-full rounded-[6px] sm:rounded-3xl bg-stone-900">
                <img
                  src="assets/ipimg4.png"
                  alt="From Sketch to Screen: Our Art Pipeline Explained"
                  className="object-contain self-stretch w-full rounded-[6px] sm:rounded-3xl aspect-[1.49]"
                />
                <h2 className="mt-6 text-2xl font-medium tracking-tight text-zinc-100">
