    ...
    <div className='px-[22px] sm:px-[104px] sm:pt-[105px]'>
      ...
      <div>
        <div className='flex flex-col sm:flex-row gap-[38px]'>
          <div className='bg-[#0F0F0F] rounded-[16px] sm:rounded-[36px] sm:w-1/2'>
      ...
      {/* <div className=' pt-[38px] sm:pt-[64px]'>
        <div className='flex flex-col sm:flex-row  gap-[38px]'>
          <div className='bg-[#0F0F0F] rounded-[16px] sm:rounded-[36px]'>
            ...
            <p className='text-[16px] sm:text-[32px] text-[#8B8A8A] px-[15px] sm:px-[40px] pt-[28px] sm:p-[40px] '>A UI/UX Upgrade That Simplified Enterprise Workflows</p>
            <div className='px-[15px] sm:px-[40px] pt-[28px] sm:pt-[4px] pb-[24px] sm:pb-[46px]'>
          ...
          <div className='bg-[#0F0F0F] rounded-[16px] sm:rounded-[16px]'>
            ...
            <p className='text-[16px] sm:text-[32px] text-[#8B8A8A] px-[15px] sm:px-[40px] pt-[28px] sm:p-[40px] '>Revamped website for modern, performance-driven user experience.</p>
            <div className='px-[15px] sm:px-[40px] pt-[28px] sm:pt-[4px] pb-[24px] sm:pb-[46px]'>
