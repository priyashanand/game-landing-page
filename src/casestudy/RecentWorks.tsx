...
const RecentWorks:React.FC = () => {
  return (
    <div className='px-[22px] sm:px-[104px] sm:pt-[105px]'>
      <h1 className=' text-[24px] sm:text-[48px] font-bold tracking-[-1.2px] bg-gradient-to-br from-white to-[#71717A] text-transparent bg-clip-text leading-tight pb-[40px]'>Recent Best Works</h1>
      <p className='text-[24px] sm:text-[20px] font-bold text-[#EBEBEB]'>We don’t just design — we transform.</p>
      <p className='text-[13px] sm:text-[20px] text-[#A1A1AA] pb-[40px] sm:pb-[78px]'>
      ...
      <div className=' pt-[64px]'>
        <div className='flex flex-col sm:flex-row  gap-[38px]'>
          ...
          <div className='bg-[#0F0F0F] rounded-[36px]'>
            ...
            <p className='text-[16px] sm:dtext-[32px] text-[#8B8A8A] px-[15px] sm:px-[0px] pt-[28px] sm:pt-[0px] sm:p-[40px]'>A full UX revamp that turned casual players into loyal fans</p>
            <div className='px-[15px] sm:px-[40px] pt-[28px] sm:pt-[4px] pb-[24px] sm:pb-[46px]'>
