function Footer() {
  return (
    <footer className="flex flex-col items-center px-[104px] pt-6 pb-6 max-md:px-5">
      <div className="flex flex-col sm:flex-row sm:flex-wrap gap-[24px] sm:gap-10 justify-center sm:justify-between items-center max-w-full sm:border-b border-solid border-b-[color:var(--neutral-015,rgba(255,255,255,0.10))] w-full">
