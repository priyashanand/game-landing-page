...
const MobRevolving:React.FC = () => {
  return (
    <div className='pt-[63px]'>
      <div className='flex flex-col items-center gap-[41px] px-[22px] pb-[54px]'>
        <div className='flex flex-col gap-[32px]'>
          <h1 className='text-white text-[24px] leading-[32px] tracking-[-1.2px] font-bold text-center px-[28px]'>Building a seamless Web2 + Web3 Purchases for a AAA Game</h1>
          <p className='text-[13px] text-[#A1A1AA] text-center leading-5'>Clyde built a secure, responsive checkout embedded in the game server, allowing players to pay instantly with Stripe or USDT without ever leaving gameplay.</p>
          
        </div>
        <img src="/assets/revimg.png" alt="" />
      </div>
      ...
      <div className='px-[22px] pt-[54px] pb-[54px] '>
        ...
        <p className='text-[13px] text-[#A1A1AA] font-medium text-center leading-5'>A next-gen game needed a frictionless, in-game purchase experience that worked seamlessly across fiat (Stripe) and crypto (USDT) — without pulling players out of the gameplay. Clyde was brought in to design and build a secure, responsive web purchase flow integrated with their game server.</p>
      </div>
      ...
      <div className='pt-[38px] pb-[54px]  '>
        <h1 className=' text-[24px] sm:text-[48px] font-bold tracking-[-1.2px] bg-gradient-to-br text-center sm:text-left from-white to-[#71717A] text-transparent bg-clip-text leading-tight pt-[40px] sm:pt-0 pb-[32px] px-[22px]'>How did we build Revolving Games?</h1>
        <p className='px-[22px] pb-[40px] text-[#A1A1AA] text-center text-[13px] '>Building a revolving game requires smart design, real-time tech, and seamless monetization. Here are the four key steps:</p>
        <div>
        <div className='flex flex-col justify-between px-[22px] gap-[28px]'>
          <div className='flex items-center gap-[22px]'>
            <img src="/assets/1.png" alt="" className='h-[96px]'/>
            <p className='text-start text-[15px] text-white'>Core Gameplay <br /> Development</p>
          </div>
          <div className='flex items-center gap-[22px]'>
            <img src="/assets/2.png" alt="" className='h-[96px]'/>
            <p className='text-start text-[15px] text-white'>Backend & Live Server <br />Integration</p>
          </div>
          <div className='flex items-center gap-[22px]'>
            <img src="/assets/3.png" alt="" className='h-[96px]'/>
            <p className='text-start text-[15px] text-white'>Monetization & <br />Purchase Flow</p>
          </div>
          <div className='flex items-center gap-[22px]'>
            <img src="/assets/4.png" alt="" className='h-[96px]'/>
            <p className='text-start text-[15px] text-white'>Live Operations & <br />Content Updates</p>
          </div>
        </div>
     ...
     <div className='px-[22px]'>
      ...
      <div className='px-[22px] pt-[54px] pb-[54px]'>
        <h1 className=' text-[24px] sm:text-[48px] font-bold tracking-[-1.2px] bg-gradient-to-br text-center sm:text-left from-white to-[#71717A] text-transparent bg-clip-text leading-tight pb-[32px]'>What We Delivered</h1>
        <div className=' gap-[52px]'>
          <div className='flex flex-col gap-6 justify-between'>
            <div className='flex items-center p-[14px] bg-[#121315] border border-[#171717] rounded-lg'>
              <Plusicon/>
              <p className='text-[13px] text-[#939393] leading-[28px] pl-[12px]'>Boosted purchase conversion rates</p>
            </div>
            <div className='flex items-center p-[14px] bg-[#121315] border border-[#171717] rounded-lg'>
              <Plusicon/>
              <p className='text-[13px] text-[#939393] leading-[28px] pl-[12px]'>Improved User retention</p>
            </div>
            <div className='flex items-center p-[14px] bg-[#121315] border border-[#171717] rounded-lg'>
              <Plusicon/>
              <p className='text-[13px] text-[#939393] leading-[28px] pl-[12px]'>Reduced drop-offs across payment flows</p>
            </div>
            <div className='flex items-center p-[14px] bg-[#121315] border border-[#171717] rounded-lg'>
              <Plusicon/>
              <p className='text-[13px] text-[#939393] leading-[28px] pl-[12px]'>Boosted purchase conversion rates</p>
      ...
      <div className='px-[22px] pt-[54px] pb-[32px]'>
        <h1 className=' text-[24px] sm:text-[48px] font-bold tracking-[-1.2px] bg-gradient-to-br text-center sm:text-left from-white to-[#71717A] text-transparent bg-clip-text leading-tight pb-[40px]'>Tracking Performance and Measuring Results</h1>
        <div className=' gap-[80px]'>
          <img src="/assets/tracking.png" alt="" className='pb-[38px]'/>
          <div className='flex  gap-[14px]'>
            <div style={{background: 'linear-gradient(180deg, rgba(0, 142, 153, 0.26) 0%, rgba(255, 255, 255, 0.00) 100%)'}} className='flex flex-col items-center gap-[8px] justify-center  rounded-2xl py-[12px] w-1/2'>
              <h1 className='text-[40px] text-white font-semibold text-center'>70%</h1>
              <p className='text-[#B5B2B2] text-[16px] text-center'>Boost in player retention</p>
            </div>
            <div style={{background: 'linear-gradient(180deg, rgba(0, 142, 153, 0.26) 0%, rgba(255, 255, 255, 0.00) 100%)'}} className='flex flex-col items-center gap-[8px] h-1/2 justify-center  rounded-2xl py-[12px]'>
              <h1 className='text-[40px] font-semibold text-white text-center'>3x</h1>
              <p  className='text-[#B5B2B2] text-[16px] text-center'>Average play sessions</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className='px-[22px] pb-[48px]'>
        <div className='px-[14px] py-[24px] bg-[#101012] rounded-2xl'>
          <div className='flex gap-[14px]'>
            <img src="/assets/revfounder.png" alt="" className='h-[37px]'/>
            <div>
              <h1 className='text-[14px] text-[#FFFCF6]  font-semibold'>Nick Chadda</h1>
              <p className='text-[#84A5AA] text-[12px] leading-[20px] text-center'>Co-Founder @ Revolving Games</p>
            </div>
          </div>
      ...
      {/* Ready to build */}
      <div className='px-[22px]  pb-[68px]'>
        <div className='bg-[url("/assets/bg5.png")] bg-cover bg-left-bottom flex flex-col items-center rounded-[16px]'>
          <h1 className='text-[20px] text-[#A0C2FF] font-semibold text-center pt-[40px]'>Ready to build a modern hybrid <br />payment flow for your game?</h1>
          <div className='pt-[21px] pb-[48px]'>
          <Link to="/contact">
